...
var require_solarlunar_min = __commonJS({
  "node_modules/solarlunar/lib/solarlunar.min.js"(exports, module) {
    !function(b, f) {
      ...
      return function(b) {
        ...
        var t = e(2), a = c(t), r = e(3), n = c(r), d = e(4), u = c(d), s = e(5), o = c(s), l = e(6), i = c(l), p = e(7), y = c(p), h = e(8), v = c(h), g = e(9), D = c(g), M = e(10), _ = c(M), m = e(11), x = c(m), T = e(12), j = c(T), I = { lunarInfo: a.default, solarMonth: n.default, gan: u.default, zhi: o.default, animals: i.default, lunarTerm: y.default, lTermInfo: v.default, nStr1: D.default, nStr2: _.default, nStr3: x.default, nStr4: j.default, lYearDays: function(b2) {
          var f2, e2 = 348;
          for (f2 = 32768; f2 > 8; f2 >>= 1) e2 += I.lunarInfo[b2 - 1900] & f2 ? 1 : 0;
          ...
          if (b2 < 1900 || b2 > 2100) return -1;
          if (f2 < 1 || f2 > 24) return -1;
          ...
          if (b2 < 1900 || b2 > 2100) return -1;
          if (1900 == b2 && 1 == f2 && e2 < 31) return -1;
          if (b2) var c2 = new Date(b2, parseInt(f2) - 1, e2);
          else var c2 = /* @__PURE__ */ new Date();
          ...
          for (t2 = 1900; t2 < 2101 && n2 > 0; t2++) r2 = I.lYearDays(t2), n2 -= r2;
          n2 < 0 && (n2 += r2, t2--);
          var d2 = /* @__PURE__ */ new Date(), u2 = false;
          ...
          for (t2 = 1; t2 < 13 && n2 > 0; t2++) a2 > 0 && t2 == a2 + 1 && 0 == i2 ? (--t2, i2 = true, r2 = I.leapDays(l2)) : r2 = I.monthDays(l2, t2), 1 == i2 && t2 == a2 + 1 && (i2 = false), n2 -= r2;
          ...
          I.leapDays(b2);
          if (c2 && t2 != f2) return -1;
          if (2100 == b2 && 12 == f2 && e2 > 1 || 1900 == b2 && 1 == f2 && e2 < 31) return -1;
          var a2 = I.monthDays(b2, f2);
          if (b2 < 1900 || b2 > 2100 || e2 > a2) return -1;
          for (var r2 = 0, n2 = 1900; n2 < b2; n2++) r2 += I.lYearDays(n2);
          for (var d2 = 0, u2 = false, n2 = 1; n2 < f2; n2++) d2 = I.leapMonth(b2), u2 || d2 <= n2 && d2 > 0 && (r2 += I.leapDays(b2), u2 = true), r2 += I.monthDays(b2, n2);
          c2 && (r2 += a2);
...
export default require_solarlunar_min();
